...
export const lowStockCheckHandler = __BLOCKS_ApiNamespaceClient__('lowStockCheckHandler');

export const generateClient = (config) => ({
    api: __BLOCKS_ApiNamespaceClient__('api', config),
    lowStockCheckHandler: __BLOCKS_ApiNamespaceClient__('lowStockCheckHandler', config),
});